const films = [
   ...
   let moveBOX = document.querySelector(".film-box")
      ...
      films.forEach((film) => {
        ...
        <div class="movie-box">
         <div class="movie-img">
            <img src="${film.poster}" alt="" width="150" />
         </div>
               <div class="movie-info">
               <h4 class="movie-name-1" style="color: crimson;text-transform: uppercase;">${film.title}</h4>
               
               <p>Genres:</p>
               <p class="movie-genres-1">${film.genres.join(' ')}</p>
               <p class="movie-id-1">id: ${film.id}</p>
               </div>
        </div>
         `;
